...
export const unsetToken = () => {
  ...
  Cookie.remove('user')
  console.log('Unsetting all token is called')
...
export const getUserFromServerCookie = (req) => {
  console.log('A function call to getUser from server cookie with request url path of ', req.path)
  console.log('There is a cookie in request object ?', req.headers.cookie != null)
...
export const getUserFromLocalCookie = () => {
  console.log('Get user from local cookie is called')
  console.log('The result reading user cookies is ', Cookie.getJSON('user'))
