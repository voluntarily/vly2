...
const thisReduxApi = reduxApi({
  ...
  statisticsSummary: {
    url: '/api/statistics/summary/:orgId/:timeframe',
    crud: false, // Make CRUD actions: https://github.com/lexich/redux-api/blob/master/docs/DOCS.md#crud
    transformer: apiTransformer,
    helpers: {
      get (orgId, timeframe) {
        return [{ orgId, timeframe }, {}]
      }
    }
  }
})
...
export const withStatistics = PageComponent => withReduxEndpoints(PageComponent, ['statisticsSummary'])
