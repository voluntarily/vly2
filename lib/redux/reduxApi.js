...
const thisReduxApi = reduxApi({
  ...
  .use('options', (url, params, getState) => {
    ...
    if (idToken) {
      options.headers.Authentication = `Bearer ${idToken}`
    }
    return options
  })
...
export const withHomeData = PageComponent => withReduxEndpoints(PageComponent, ['opportunities', 'archivedOpportunities', 'recommendedOps', 'interests', 'members', 'tags', 'locations', 'activities', 'personalGoals', 'interestsArchived'])
