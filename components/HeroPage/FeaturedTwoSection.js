...
const FeaturedTwoSection = () => (
    ...
    <HalfGrid>
        <BigOpContainer>
            ...
            <BigOpDateTime>2 Hours / Monday 24 May  / Edendale Primary School</BigOpDateTime>
            <BigOpDescription>I have a class that wants to learn about robotics and electronics by making autonomous robot vacuum cleaners. We have the materials, we just need an expert! </BigOpDescription>
        </BigOpContainer>
        ...
        <BigOpContainer>
            ...
            <BigOpDescription>We need volunteers to teach programming and technology using circuits to students</BigOpDescription>
        </BigOpContainer>
        <BigOpContainer>
            <BigOpImg src="https://robotclinic.co.uk/wp-content/uploads/2018/01/Xiaomi-Mi-Robot-Vacuum-Teardown.jpg"/>
            <BigOpTitle>Build robot vacuum cleaners with us</BigOpTitle>
            <BigOpDateTime>2 Hours / Monday 24 May  / Edendale Primary School</BigOpDateTime>
            <BigOpDescription>We want to learn about robotics and electronics by making robot vacuums that clean the school for us</BigOpDescription>
        </BigOpContainer>
