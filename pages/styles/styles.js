...
const Styles = () =>
  <FullPage>
    <div id='top' class='page' role='document'>
      <h1>HTML Tag CSS Style example page</h1>
      <p>This page demonstrates what all the main HTML tags look like with the currently applied CSS</p>
      <nav role='navigation'>
        <ul>
          <li>
            <a href='#text'>Text</a>
  ...
  p q r s t u v w x y z ~ </pre>
        ...
        <section id='embedded'>
          ...
          <article id='embedded__iframe'>
            ...
            <div><iframe src='/static/loading.svg' height='300' /></div>
            <footer><p><a href='#top'>[Top]</a></p></footer>
          </article>
        </section>
        <section id='forms'>
