...
<p>These terms and conditions outline the rules and regulations for the use of Voluntarily's Website.</p>

<p><b>1.APPLICATION OF TERMS</b></p>
<p>1.1 These Terms apply to your use of the Website. By accessing and using the Website:
You agree to these Terms; 
and where your access and use is on behalf of another person (e.g. a company), you confirm that you are authorised to, and do in fact, agree to these Terms on that person’s behalf
and that, by agreeing to these Terms on that person’s behalf, that person is bound by these Terms.</p>
<p>1.2 If you do not agree to these Terms, you are not authorised to access and use the Website, and you must immediately stop doing so.</p>
<p>1.3 PFCT may vary this policy at any time. The current version of the policy will be maintained on the Web site.</p>

<p><b>2 CHANGES</b></p>
<p>2.1 We may change these Terms at any time by updating them on the Website. Unless stated otherwise, any change takes effect immediately. You are responsible for ensuring you are familiar with the latest Terms. By continuing to access and use the Website, you agree to be bound by the changed Terms.</p>
<p>2.2 PFCT makes no warranty or representation, express or implied, as to continuity of service. It reserves the right to suspend, terminate or otherwise alter access to some or all of the site’s services at any time and without notice. We may change, suspend, discontinue, or restrict access to, the Website without notice or liability.</p>
<p>2.3 These Terms were last updated on 29 February 2020. </p>

<p><b>3 DEFINITIONS</b></p>
<p>In these Terms:</p>
<p>including and similar words do not imply any limit</p>
<p>Loss includes loss of profits, savings, revenue or data, and any other claim, damage, loss, liability and cost, including legal costs on a solicitor and own client basis</p>
...
<p>We, us or our means Pam Fergusson Charitable Trust</p>
<p>Website means Voluntarily.nz</p>
<p>You means you or, if clause 1.1b applies, both you and the other person on whose behalf you are acting.</p>

<p><b>4 YOUR OBLIGATIONS</b></p>
<p>4.1 You must provide true, current and complete information in your dealings with us (including when setting up an account), and must promptly update that information as required so that the information remains true, current and complete.</p>
<p>4.2 If you are given a User ID, you must keep your User ID secure and:</p>
<p>not permit any other person to use your User ID, including not disclosing or providing it to any other person; and
immediately notify us if you become aware of any disclosure or unauthorised use of your User ID, by sending an email to hello@voluntaily.nz.</p>
<p>4.3 You must:
...
<p>4.4 You must obtain our written permission to establish a link to our Website. If you wish to do so, email your request to hello@voluntaily.nz.</p>
<p>4.5 You indemnify us against all Loss we suffer or incur as a direct or indirect result of your failure to comply with these Terms, including any failure of a person who accesses and uses our Website by using your User ID.</p>

<p><b>5 INTELLECTUAL PROPERTY AND COPYRIGHT</b></p>
<p>5.1 We (and our licensors) own all proprietary and intellectual property rights in the Website (including all information, data, text, graphics, artwork, photographs, logos, icons, sound recordings, videos and look and feel), and the Underlying Systems.</p>
<p>5.2 The copyright in all materials displayed or available on this Web site is the property of PFCT unless otherwise stated. If the owner of any material published on this Web site is not PFCT, the rights in respect of that material will be as defined by the copyright owner of the material concerned. Unless otherwise stated you are permitted to copy textual material published by PFCT for your own non-commercial use provided you retain and display any copyright notice applying to the material. No material from this Web site may be reproduced or distributed in any media without written permission from PFCT.</p>
<p>5.3 · The platform’s re-use licence does not apply to material that is subject to third party copyright.<p>
<p>5.4 Hyperlinking to our Content. The following organizations may link to our Web site without prior written approval:</p>
...
<p>5.5 Other than personal information, which is covered under the Privacy Policy, any material you transmit or post to the site is considered non-confidential. This includes feedback or submissions you provide. We do not claim to own your copyright material. You do, however, grant PFCT a non-exclusive, royalty-free and irrevocable licence to:</p>
<p>publish such material in any media and in any format, including:</p>
<p>on this or any other website</p>
<p>in hard copy publications</p>
<p>in email notifications or alerts</p>
<p>in web feeds, and</p>
<p>sub-license such material for re-use by others on the same terms as the licence you’ve granted PFCT.</p>
<p>5.6 If your contributions to the site include material in which copyright or other intellectual property is owned by a third party, you warrant that you have the right to use that material and to grant the licence referred to in, and on the terms of, the clause above.</p>
...
6.3 The Pam Fergusson Charitable Trust (PFCT) tries to ensure the information on this Web site is accurate and current but does not accept liability for any error or omission it may contain. All warranties expressed or implied as to the accuracy or completeness of the information on this Web site, or in respect of any products or materials referred to, are excluded to the extent permitted by law.
6.4 Links here may lead to other Web sites, and some information on this Web site may be provided by third parties. PFCT accepts no responsibilities for the currency or accuracy of such information. You should verify it with those parties directly.
6.5 The information contained on this Web site is intended to provide general information about PFCTs current products and is subject to change without notice. 
...
The purpose of this privacy policy is to let users of voluntarily.nz (the ‘site’) know when we collect personal information and what we do with it.
...
8.1 This privacy notice applies to personal information collected on voluntarily.nz and voluntari.ly
8.2 You are not required to provide personal information to us, although in some cases if you choose not to do so then we will be unable to make certain sections of the Website available to you. For example, we need to have your contact information in order to allow you to volunteer from our Website.
8.3 When you provide personal information to us, we will comply with the New Zealand Privacy Act 1993.
8.4 The personal information you provide to us (including any information provided if you register for an account) is collected and may be used for verify your identity, communicating with you, make recommendations to you for volunteering activities, connecting you to activity or opportunity providers, statistical analysis, the marketing by us of products and services to you, allow people running activities to learn about who will be working with their children and young people., police checks (if agreed) and research and development.
8.5 We may also collect technical information whenever you log on to, or visit the public version of, our Website. This may include users IP addresses, information about the way users arrive at, browse through and interact with our Website. We may collect this type of technical information through the use of cookies and other means. Cookies are alphanumeric identifiers that we transfer to your computer’s hard drive to enable our systems to recognise your browser. If you want to disable cookies, you may do so by changing the settings on your browser. However, if you do so, you may not be able to use all of the functions on the Website. We use the technical information we collect to have a better understanding of the way people use our Website, to improve the way it works and to personalise it to be more relevant and useful to your particular needs. We may also use this information to assist in making any advertising we display on the Website more personalised and applicable to your interests.
...
to an opportunity provider whom you have registered to volunteer for to enable a successful volunteering opportunity
to activity providers or opportunity creators for the purpose of finding the best volunteers for an activity or opportunity
to your employer is connected to a business account for the purpose of tracking volunteering opportunities
...
8.8 You have the right to request access to and correction of any of the personal information we hold about you. If you would like to exercise these rights, please email us at hello@voluntaily.nz.
8.9 Confidential information held by PFCT in relation to the users business will not be disclosed to a connected business unless authorised by the administrator of the business to which the information relates. 

<p><b>9 CHILD SAFETY AND VETTING</b></p>
...
<p><b>9 SUSPENSION AND TERMINATION</b></p>
